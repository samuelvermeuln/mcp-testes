...
ENV GOSYSTEM_MCP_TRANSPORT=streamable-http
ENV GOSYSTEM_MCP_HOST=0.0.0.0
ENV GOSYSTEM_MCP_PORT=8000
ENV GOSYSTEM_MCP_PATH=/mcp
ENV GOSYSTEM_MCP_STATELESS_HTTP=true
ENV GOSYSTEM_MCP_JSON_RESPONSE=true
ENV GOSYSTEM_MCP_CONFIG_TOML=/data/config.toml
